class ScrollLib:
    ...
    m_lib = {
        ...
        'Prime Scroll for Armor': {
            ...
            'restriction': ['Hat', 'Secondary', 'Top', 'Overall', 'Bottom', 'Shoe', 'Cape', 'Belt', 'Glove'],
            'secondary': ['Shield'],
        ...
        'Prime Scroll for Accessories': {
            'type': 'Scroll',
            'success rate': 0.4,
            'boom rate': 0.3,
            'effect': 'Prime Scroll for Armor',
            'restriction': ['Eye', 'Face', 'Ring', 'Pendant', 'Earring'],
            'description': 'Improves accessory stats.\n\nWorks on:\nEye\nFace\nRing\nPendant\nEarring\n\n',
            # market info
            'cost': ['Meso','Event Coin'],
            'value': [1, 1],
            'stock': [5, 0],
        ...
        'STR for Weapon 15%': {
            ...
            'restriction': ['Weapon', 'Secondary'],
            'secondary': ['Katara'],
            'description': 'Improves Weapon ATT and STR for weapons and kataras.\n',
            # market info
            'cost': ['Trace'],
            'value': [1],
            'stock': [-1],
